...
async def join_channel():
    try:
        await sython(JoinChannelRequest("@bz1bb"))
...
async def _(event):
        ...
        await sython.send_message('@EEObot', 'جاري التجميع بواسطة | 𝗦𝗼𝗨𝗿𝗖𝗲 Raven')
        channel_entity = await sython.get_entity(bot_username)
...
async def _(event):
        ...
        await sython.send_message('@Ershkalibot', 'جاري التجميع بواسطة | 𝗦𝗼𝗨𝗿𝗖𝗲 Raven')
        channel_entity = await sython.get_entity(bot_usernameee)
...
async def _(event):
        ...
        await sython.send_message('@A_MAN9300BOT', 'جاري التجميع بواسطة | 𝗦𝗼𝗨𝗿𝗖𝗲 Raven')
        channel_entity = await sython.get_entity(bot_usernamee)
...
async def _(event):
      await event.reply("""السـورس يعمـل | 𝗦𝗼𝗨𝗿𝗖𝗲 Raven
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍
...
async def _(event):
      await event.edit(""" RaVeN الــديــكم لاخــوف عــلــعــلــيــكم
𖥔 ࣪ ˖🩸𖥔 ࣪ ˖💢 𖥔 ࣪ ˖💀𖥔 ࣪ ˖🕸𖥔 ࣪ ˖🪦𖥔 ࣪
قناه رسميه للمطور - @bz1bb
𖥔 ࣪ ˖🩸𖥔 ࣪ ˖💢 𖥔 ࣪ ˖💀𖥔 ࣪ ˖🕸𖥔 ࣪ ˖🪦𖥔 ࣪"""
)
